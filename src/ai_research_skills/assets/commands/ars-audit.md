...
1. `ars-red-team` — checkpoint A against the corpus and coverage map: terminology coverage,
...
2. `ars-verify` — BibTeX provenance, entry resolution, key consistency across draft/bib/corpus,
