...
|---|---|---|
| **A** | After `ars-survey` Phase 4, before any exit | The corpus and the coverage map |
...
to extend the corpus. Anything it finds that should be in the corpus goes back to `ars-survey`.
