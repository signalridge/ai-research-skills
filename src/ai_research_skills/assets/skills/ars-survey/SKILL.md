...
**You are the only skill allowed to search.** If `ars-gap-gate`, `ars-related-work`, `ars-watch`, or
`ars-decision-brief` needs a paper that isn't in the corpus, it comes back here.
...
in `protocol.yml.budget`. See [SETUP.md](https://github.com/signalridge/ai-research-skills/blob/main/docs/SETUP.md) for the verified failure modes —
