...
The `survey` skill routes across three backends (see [DESIGN.md §2.1](DESIGN.md)). This
...
[DESIGN.md rule 5](DESIGN.md#5-the-eleven-rules-and-the-failure-each-one-traces-to): in a
