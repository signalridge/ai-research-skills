...
Sweep the top 3 venues for the last 2 years minimum. Workshop tracks matter here — early
work lands there a year before the main conference.
...
a protocol, and `watch` re-runs this file literally.
